...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  52.0        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.25       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  52.0        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Bed 50mm down for service"
  #define MAIN_MENU_ITEM_1_GCODE "G0 Z50"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Preheat for " PREHEAT_1_LABEL
  //#define MAIN_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  #define MAIN_MENU_ITEM_2_GCODE "M190 S" STRINGIFY(PREHEAT_1_TEMP_BED - 6) "\nM140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  ...
  #define MAIN_MENU_ITEM_4_DESC "Home, Leveling=on, Endstops=off"
